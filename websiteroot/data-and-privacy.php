...
<div class="container">
  <div class="jumbotron">
    <div class="row">
      <div class="col-lg-12">
        <h2 class="text-center"><font color="#428BCA">Privacy Policy</font></h2>
        <p>>At FlipUp we are committed to safeguarding and preserving the privacy of our visitors. This Website Privacy Policy has been provided by the legal resource www.diylegals.co.uk and reviewed and approved by their solicitors.</p>
        ...
        <p>In running and maintaining our website we may collect and process the following data about you:
          <ul>
            ...
            <li>that you provide when you communicate with us by any means.</li>
          </ul>
        </p>
