...
<?php pageHead(); ?>
      ...
      <div class="row">
        <div class="col-lg-12">
          <h2 class="text-center"><font color="#428BCA">Terms &amp Conditions</font></h2>
          ...
          <h3>Site Uptime</h3>
          <ul>
            <li>All reasonable measures are taken by us to ensure that this website is in operation most of the time. However, occasionally technical issues may result in some downtime and accordingly we will not be liable if this website is unavailable at any time.</li>
          ...
          <h3>Disclaimer</h3>
          <ul>
            <li>Whilst we do take all reasonable steps to make sure that the information on this website is up to date and accurate at all times we do not guarantee that all material is accurate and ,or up to date.</li> 
          ...
          <ul>
            <li>We do not accept liability for any loss or damage that you suffer as a result of using this Website.</li>
          ...
          <a class="btn btn-primary" href="about.php" role="button">Back</a></p>
       </div>
     </div>
    </div>
   </div>
