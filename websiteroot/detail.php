...
<?php pageHead(); ?>
      ...
      <div class="row">
        ...
        <h2><font color="#428BCA">How can I share my result with my friends if I do not have an account?</font></h2>
        <h2><font color="#428BCA">How can I register to the website?</font></h2>
        ...
        <h2><font color="#428BCA">How can I improve my result?</font></h2>
        <p>You could improve your result by reading more on the topic and by solving as many quizzes as it required.</p>
        <h2><font color="#428BCA">Why is it different?</font></h2>
        <h2><font color="#428BCA">What if I forget my password?</font></h2>
        ...
        <h2><font color="#428BCA">What if I decided to change the subject in the middle of the quiz?</font></h2>
        <p>You could always go to the subject button on the top of the page and choosing another subject.</p>
        <h2><font color="#428BCA">How can I choose a subject?</font></h2>
        ...
        <h2><font color="#428BCA">How can a quiz generate?</font></h2>
